...
for _ in range(len(w1)):
    ...
    if gp.quicksum(x_ij[i, j] * C[i] for i in Set_I for j in Set_J) - a1 > 0:
        if gp.quicksum(x_ij[i, j] * PR[i] for i in Set_I for j in Set_J) - a2 > 0:
            if -(gp.quicksum(x_ij[i, j] * P[i] for i in Set_I for j in Set_J)) - a3 > 0:
                m1.setObjective(((gp.quicksum(x_ij[i, j] * C[i] for i in Set_I for j in Set_J) - a1) * w1[_]) +
                                ((gp.quicksum(x_ij[i, j] * PR[i] for i in Set_I for j in Set_J) - a2) * w2[_]) +
                                ((-(gp.quicksum(x_ij[i, j] * P[i] for i in Set_I for j in Set_J)) - a3) * w3[_]) +
                                alpha * (gp.quicksum(x_ij[i, j] * C[i] for i in Set_I for j in Set_J) - a1 +
                                         gp.quicksum(x_ij[i, j] * PR[i] for i in Set_I for j in Set_J) - a2 +
                                         (-(gp.quicksum(x_ij[i, j] * P[i] for i in Set_I for j in Set_J)) - a3)),
                                GRB.MINIMIZE)
            else:
                m1.setObjective(((gp.quicksum(x_ij[i, j] * C[i] for i in Set_I for j in Set_J) - a1) * w1[_]) +
                                ((gp.quicksum(x_ij[i, j] * PR[i] for i in Set_I for j in Set_J) - a2) * w2[_]) +
                                ...
                                alpha * (gp.quicksum(x_ij[i, j] * C[i] for i in Set_I for j in Set_J) - a1 +
                                         ...
                                         (gp.quicksum(x_ij[i, j] * P[i] for i in Set_I for j in Set_J) - a3)),
                                GRB.MINIMIZE)
        elif -(gp.quicksum(x_ij[i, j] * P[i] for i in Set_I for j in Set_J)) - a3 > 0:
            m1.setObjective(((gp.quicksum(x_ij[i, j] * C[i] for i in Set_I for j in Set_J) - a1) * w1[_]) +
                            ((gp.quicksum(x_ij[i, j] * PR[i] for i in Set_I for j in Set_J) - a2) * w2[_]) +
                            ((-(gp.quicksum(x_ij[i, j] * P[i] for i in Set_I for j in Set_J)) - a3) * w3[_]) +
                            alpha * (gp.quicksum(x_ij[i, j] * C[i] for i in Set_I for j in Set_J) - a1 +
            ...
            m1.setObjective(((gp.quicksum(x_ij[i, j] * C[i] for i in Set_I for j in Set_J) - a1) * w1[_]) +
                            ...
                            alpha * (gp.quicksum(x_ij[i, j] * C[i] for i in Set_I for j in Set_J) - a1 +
                                     ...
                                     (gp.quicksum(x_ij[i, j] * P[i] for i in Set_I for j in Set_J) - a3)),
                            GRB.MINIMIZE)
    elif gp.quicksum(x_ij[i, j] * PR[i] for i in Set_I for j in Set_J) - a2 > 0:
        if -(gp.quicksum(x_ij[i, j] * P[i] for i in Set_I for j in Set_J)) - a3 > 0:
            m1.setObjective(((gp.quicksum(x_ij[i, j] * C[i] for i in Set_I for j in Set_J) - a1) * w1[_]) +
                            ((gp.quicksum(x_ij[i, j] * PR[i] for i in Set_I for j in Set_J) - a2) * w2[_]) +
                            ((-(gp.quicksum(x_ij[i, j] * P[i] for i in Set_I for j in Set_J)) - a3) * w3[_]) +
