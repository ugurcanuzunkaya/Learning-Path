...
while True:
    ...
    m1.addConstr((beta <= epsilon2), name='epsilon_cons')

    m1.setObjective(gp.quicksum(distance[i - 1, j - 1] * x_ijk[i, j, k] for i in set_I for j in set_J for k in set_K),
                    GRB.MINIMIZE)
