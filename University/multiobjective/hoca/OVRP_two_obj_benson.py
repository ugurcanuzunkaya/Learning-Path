...
while True:
    ...
    m1.addConstr((benson2 - l2 - beta == 0),name='benson2_cons')
    m1.addConstr((benson1 - l1 - gp.quicksum(distance[i-1, j-1]*x_ijk[i,j,k] for i in set_I for j in set_J for k in set_K) == 0), name='benson1_cons')
    m1.setObjective(l1 + l2, GRB.MAXIMIZE)
